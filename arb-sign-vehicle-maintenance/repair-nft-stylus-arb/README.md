...
# Stylus for Eth Garage
Functionality: Repair NFTs on Farcaster issued to Vehicle Service providers on completion of repair work/vehicle servicing using Arbitrum Stylus programs in Rust.
We are extending the Project starter template for writing Arbitrum Stylus programs in Rust using the [stylus-sdk](https://github.com/OffchainLabs/stylus-sdk-rs). It includes a Rust implementation of a basic counter Ethereum smart contract:
